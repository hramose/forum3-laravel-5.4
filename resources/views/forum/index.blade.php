...
<div class="container">
    <div class="row">
        <div class="col-md-8 col-md-offset-2 container-bottom-margin">
          ...
          <div class="row row-bottom-margin">
            <div class="col-md-12">
              @if (!Auth::check())
                <div>If you would like to join in the discussion, please <a href="{{ route('login') }}">login</a> or <a href="{{ route('register') }}">register</a>.</div>
              @else
